...
<style>
    ...
    /* Force white text and orange accents for headers/metrics */
    h1, h2, h3, .stHeader, .stSubheader, .stMarkdown h1, .stMarkdown h2, .stMarkdown h3 {
    ...
    /* Make sure sidebar and main content stay dark */
    .stSidebar, .stSidebar > div {
        background-color: #16181f !important;
        color: #ffffff !important;
    }
    
    /* Stronger orange for tabs and dividers */
